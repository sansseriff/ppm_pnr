...
\author{Andrew Mueller\authormark{1, 2, *}, Boris Korzh\authormark{2}, Emma E. Wollman\authormark{2}, Ioana Craiciu\authormark{2}, Andrew D. Beyer\authormark{2}, Makan Mohageg\authormark{2}, {Lautaro Narv\'aez}\authormark{3},  Maria Spiropulu\authormark{3}, Matthew D. Shaw\authormark{2}}
...
\email{\authormark{*}amueller@caltech.edu} %% email address is required; see note below about the corresponding author designation
...
\todo[inline]{Calculate reduction in power from state of the art SFP modules}
...
\begin{itemize}
    ...
    \item Afterpulsing = 0 \%
    \item Jitter = 15 ps
    \item Deadtime = 30 ns \todo[inline]{measure 3dB flux}
...
In the future, the performance of the optical communication system could be improved by using, high count rate SNSPD arrays. Recently published high-count rate arrays have figures of merit of \todo[inline]{$FoM_T$ for Peacoq and Resta2023 results}. This would result a proportinal increase in the data rate.
\todo[inline]{$FoM_T$ for fastest InGaAs/InP gated detector}.
...
\todo[inline]{$FoM_T$ for DSOC array}.
